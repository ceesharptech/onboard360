  ...
  return (
    <div className="flex flex-col gap-1.5 text-left">
      ...
      <input
        ...
        } focus:border-white/40 focus:ring-1 focus:ring-white/20 focus:outline-none text-[#f7f8f8] text-xs sm:text-sm rounded-md px-3 py-2 font-normal transition-colors placeholder-[#5a5e6b] ${className}`}
        {...props}
      />
